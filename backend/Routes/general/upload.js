...
// uploads
router.post('/', 
    require('../../middleware/upload').authMiddleware,
    require('../../middleware/upload').uploads.single("ProfilePic"),
    async(req,res)=>{
        try{
        ...
        const fileUpload = await User.updateOne({"username":req.customData.token.username},
